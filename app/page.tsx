...
const projects = [
  ...
  {
    name: "SecProyecto",
    description: "Proyecto de seguridad informática con algoritmos de encriptación avanzados y blockchain",
  ...
  {
    name: "Health Checker",
    description: "Aplicación de monitoreo de salud de servicios web con métricas avanzadas y dashboards",
